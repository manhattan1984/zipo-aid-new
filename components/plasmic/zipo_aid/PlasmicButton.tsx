...
import sty from "./PlasmicButton.module.css"; // plasmic-import: d_44jQYJpk3I/css
  ...
  const stateSpecs: Parameters<typeof p.useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.ghost
      }
    ],
    [$props, $ctx, $refs]
  );
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_gold]: hasVariant($state, "color", "gold"),
          [sty.rootcolor_gold_ghost]:
            hasVariant($state, "color", "gold") &&
          ...
          [sty.rootcolor_teal]: hasVariant($state, "color", "teal"),
          [sty.rootcolor_teal_ghost]:
            hasVariant($state, "color", "teal") &&
            hasVariant($state, "ghost", "ghost"),
          [sty.rootcolor_white]: hasVariant($state, "color", "white"),
          [sty.rootcolor_white_ghost]:
            hasVariant($state, "ghost", "ghost") &&
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__aw5IX)}
                role={"img"}
              />
            ),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          ...
          [sty.contentContainercolor_gold_ghost]:
            hasVariant($state, "color", "gold") &&
            hasVariant($state, "ghost", "ghost"),
          [sty.contentContainercolor_teal_ghost]:
            hasVariant($state, "color", "teal") &&
            hasVariant($state, "ghost", "ghost"),
      ...
      >
        {p.renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrencolor_gold_ghost]:
              hasVariant($state, "color", "gold") &&
              hasVariant($state, "ghost", "ghost"),
            ...
            [sty.slotTargetChildrencolor_teal]: hasVariant(
              $state,
              "color",
              "teal"
            ),
            [sty.slotTargetChildrencolor_teal_ghost]:
              hasVariant($state, "color", "teal") &&
              hasVariant($state, "ghost", "ghost"),
            ...
            [sty.slotTargetChildrencolor_white_ghost]:
              hasVariant($state, "ghost", "ghost") &&
              hasVariant($state, "color", "white"),
